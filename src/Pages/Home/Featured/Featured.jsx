...
const Featured = () => {
    return (
        <div className="bg-FeaturedBg  text-white py-28 bg-[#151515]/70 bg-blend-overlay">
            <Header subHeading={'Check it out'} heading={'Featured Item'} />
            <div className="md:flex w-11/12 md:w-10/12 mx-auto justify-center items-center gap-8 px-10 pt-14">
                <div>
                ...
                <div className="md:ml-10 space-y-2">
                    ...
                    <button className="btn border-t-0 border-x-0 hover:bg-neutral text-white border-b-black bg-transparent border-b-4">Order Now</button>
                </div>
            </div>
        </div>
    );
